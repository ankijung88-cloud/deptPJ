...
export const VirtualReservationPage: React.FC<VirtualReservationPageProps> = ({ item: propItem, productId: propProductId, onClose }) => {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-[#FFFFFF] flex items-center justify-center text-black">
    ...
    return (
        <article className="min-h-screen text-black relative overflow-hidden font-sans bg-[#FFFFFF]">
            {/* Ambient Background */}
                ...
                {isManageModalOpen && (
                    ...
                    >
                        <motion.div 
                            ...
                            className="w-full max-w-4xl bg-[#FFFFFF] border border-black/10 rounded-[3rem] overflow-hidden shadow-2xl relative text-black"
