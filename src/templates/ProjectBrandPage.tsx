...
export const ProjectBrandPage: React.FC<{ item?: FeaturedItem }> = ({ item }) => {
    ...
    const fetchAll = async () => {
        ...
        try {
            ...
            const sample = (urlCategory && urlSubcategory ? allProducts.find(p => p.category === urlCategory && p.subcategory === urlSubcategory && p.page_type === 'brand' && (targetAgencyId ? p.agency_id?.toString() === targetAgencyId : !p.agency_id)) : null) ||
                          ...
                          (urlCategory && !urlSubcategory ? allProducts.find(p => p.category === urlCategory && p.page_type === 'brand' && (targetAgencyId ? p.agency_id?.toString() === targetAgencyId : !p.agency_id)) : null) ||
                          (urlCategory && !urlSubcategory ? allProducts.find(p => p.category === urlCategory && p.page_type === 'brand') : null) ||
