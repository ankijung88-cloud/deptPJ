...
export const FALLBACK_PRODUCTS: any[] = [
    ...
    // 4F Gather Mall
    { id: 'p4-1', subcategory: 'b2b-mall', category: 'floor-gather-mall', title: { ko: '명사 초청 문화 담론 티켓', en: 'VIP Cultural Discourse Ticket' }, description: { ko: '당대 최고의 지성들과 나누는 깊이 있는 대화입니다.', en: 'In-depth conversations with the greatest minds of our time.' }, image_url: '/via_station_logo_portal.png', price: '50,000₩' },
    { id: 'p4-2', subcategory: 'interview', category: 'floor-gather-mall', title: { ko: '아티스트 인터뷰 영상 아카이브', en: 'Artist Interview Video Archive' }, description: { ko: '작가의 철학을 날것 그대로 담아낸 독점 인터뷰입니다.', en: 'Exclusive interviews capturing the artist\'s philosophy in its raw form.' }, image_url: '/via_station_logo_portal.png', price: '15,000₩' },
    { id: 'p4-3', subcategory: 'f4_book', category: 'floor-gather-mall', title: { ko: '디자인 총서 화보집', en: 'Design Series Art Book' }, description: { ko: '수동적 독서를 넘어 영감을 주는 시각 예술 도서입니다.', en: 'A visual art book that goes beyond passive reading and provides inspiration.' }, image_url: '/via_station_logo_portal.png', price: '95,000₩' },
