...
export const FALLBACK_PRODUCTS: any[] = [
    ...
    { id: 'p6-3', subcategory: 'f6_gourmet', category: 'floor-4', title: { ko: '궁중 다과 한정판 세트', en: 'Royal Tea & Sweets Limited Set' }, description: { ko: '천년의 역사를 담은 명인의 손길로 빚은 다과 세트입니다.', en: 'A tea and sweets set crafted by a master with a thousand years of history.' }, image_url: '/via_station_logo_portal.png', price: '85,000₩' },
    { id: 'p6-4', subcategory: 'f6_craft', category: 'floor-4', title: { ko: '방짜유기 장인 식기 세트', en: 'Hand-forged Bronzeware Tableware Set' }, description: { ko: '은은한 광택과 살균 효과가 탁월한 한국 전통 식기입니다.', en: 'Traditional Korean tableware with a subtle luster and excellent sterilization effects.' }, image_url: '/via_station_logo_portal.png', price: '580,000₩' },
    { id: 'p6-5', subcategory: 'f6_tour', category: 'floor-4', title: { ko: '한양도성 달빛 탐방권', en: 'Hanyangdoseong Moonlight Exploration Pass' }, description: { ko: '성곽길을 따라 걷는 로맨틱한 야경 투어 프로그램입니다.', en: 'A romantic night tour program walking along the fortress walls.' }, image_url: '/via_station_logo_portal.png', price: '30,000₩' },

    // 5F Fashion Archive
    { id: 'p5-1', subcategory: 'archive', category: 'floor-5', title: { ko: '1970년대 명동 패션 아카이브 코트', en: '1970s Myeongdong Fashion Archive Coat' }, description: { ko: '한국 패션의 황금기를 재조명한 복각 시리즈입니다.', en: 'A replica series re-illuminating the golden age of Korean fashion.' }, image_url: '/via_station_logo_portal.png', price: '620,000₩' },
    { id: 'p5-2', subcategory: 'collection', category: 'floor-5', title: { ko: '뉴 제네레이션 캡슐 컬렉션', en: 'New Generation Capsule Collection' }, description: { ko: '라이징 디자이너들이 제안하는 이번 시즌 핵심 아이템입니다.', en: 'Key items of this season suggested by rising designers.' }, image_url: '/via_station_logo_portal.png', price: '290,000₩' },
    { id: 'p5-3', subcategory: 'f5_material', category: 'floor-5', title: { ko: '특수 가공 한지 섬유 샘플러', en: 'Specially Processed Hanji Fiber Sampler' }, description: { ko: '친환경적이며 통기성이 뛰어난 혁신 소재입니다.', en: 'An innovative material that is eco-friendly and highly breathable.' }, image_url: '/via_station_logo_portal.png', price: '15,000₩' },
    { id: 'p5-4', subcategory: 'f5_fitting', category: 'floor-5', title: { ko: '3D 스마트 피팅 서비스권', en: '3D Smart Fitting Service Pass' }, description: { ko: '정밀 스캔을 통한 완벽한 핏의 맞춤복 솔루션입니다.', en: 'A custom clothing solution with a perfect fit through precision scanning.' }, image_url: '/via_station_logo_portal.png', price: '120,000₩' },
    ...
    { id: 'p3-1', subcategory: 'performance', category: 'floor-3', title: { ko: '미디어 융합 실감 공연 티켓', en: 'Media Convergence Immersive Performance Ticket' }, description: { ko: '무대 및 기술이 하나되는 압도적 공연의 순간입니다.', en: 'A moment of overwhelming performance where the stage and technology become one.' }, image_url: '/via_station_logo_portal.png', price: '110,000₩' },
    { id: 'p3-2', subcategory: 'exhibit', category: 'floor-3', title: { ko: '디지털 캔버스 아트 워크', en: 'Digital Canvas Art Work' }, description: { ko: '공간의 분위기를 실시간으로 변화시키는 예술 경험입니다.', en: 'An art experience that changes the atmosphere of a space in real time.' }, image_url: '/via_station_logo_portal.png', price: '850,000₩' },
    { id: 'p3-3', subcategory: 'f3_media', category: 'floor-3', title: { ko: '홀로그램 이머시브 전시 관람권', en: 'Hologram Immersive Exhibition Ticket' }, description: { ko: '빛으로 구현된 가상 세계를 직접 체험해보세요.', en: 'Experience a virtual world implemented with light.' }, image_url: '/via_station_logo_portal.png', price: '25,000₩' },

    // 2F Beauty & Care
    { id: 'p2-1', subcategory: 'skincare', category: 'floor-2', title: { ko: '프리미엄 밸런싱 세럼', en: 'Premium Balancing Serum' }, description: { ko: '피부 속 깊은 곳까지 수분을 채워주는 고농축 영양 Serum입니다.', en: 'A highly concentrated nourishing serum that fills moisture deep into the skin.' }, image_url: '/via_station_logo_portal.png', price: '120,000₩' },
    { id: 'p2-2', subcategory: 'hair', category: 'floor-2', title: { ko: '실크 리페어 헤어 에센스', en: 'Silk Repair Hair Essence' }, description: { ko: '손상된 모발에 즉각적인 윤기와 부드러움을 부여하는 프로페셔널 헤어 케어입니다.', en: 'Professional hair care that gives instant shine and softness to damaged hair.' }, image_url: '/via_station_logo_portal.png', price: '68,000₩' },
    { id: 'p2-3', subcategory: 'inner-beauty', category: 'floor-2', title: { ko: '비타 부스트 콜라겐 앰플', en: 'Vita Boost Collagen Ampoule' }, description: { ko: '속부터 차오르는 생기를 위한 마시는 프리미엄 뷰티 솔루션입니다.', en: 'A drinking premium beauty solution for vitality from the inside out.' }, image_url: '/via_station_logo_portal.png', price: '85,000₩' },

    // 1F Tech & Care
    { id: 'p1-1', subcategory: 'car-care', category: 'floor-tech-care', title: { ko: '프리미엄 세정 및 코팅 키트', en: 'Premium Washing & Coating Kit' }, description: { ko: '전문가의 손길을 집에서도 경험할 수 있는 하이엔드 카케어 세트입니다.', en: 'A high-end car care set to experience a professional touch at home.' }, image_url: '/via_station_logo_portal.png', price: '75,000₩' },
    { id: 'p1-2', subcategory: 'window', category: 'floor-tech-care', title: { ko: '스마트 시티 홀로그램 키트', en: 'Smart City Hologram Kit' }, description: { ko: '내 손안의 작은 서울을 구현하는 테크 키트입니다.', en: 'A tech kit that implements a small Seoul in your hands.' }, image_url: '/via_station_logo_portal.png', price: '129,000₩' },
    { id: 'p1-3', subcategory: 'f1_kpop', category: 'floor-tech-care', title: { ko: '가상 아이돌 데뷔 앨범 컨셉 아트', en: 'Virtual Idol Debut Album Concept Art' }, description: { ko: '가상 세계의 스타를 현실로 소환하는 아트 컬렉션입니다.', en: 'An art collection that summons stars from the virtual world to reality.' }, image_url: '/via_station_logo_portal.png', price: '55,000₩' }
];
...
export const FALLBACK_STORIES: any[] = [
    ...
    { id: 's4-1', subcategory: 'b2b-mall', category: 'floor-6', title: '목소리의 파동', content: '담론 및 대화가 어떻게 세상을 바꾸는지 작가들의 목소리로 들어봅니다.', image_url: '/via_station_logo_portal.png' },
...
export const FALLBACK_NOTICES: Notice[] = [
    {
        ...
        category: '공지',
        date: '2024-03-01',
        content: { ko: '몽땅쏙이 정식 오픈하였습니다. 멤버십 가입 시 다양한 혜택을 드립니다.', en: 'The 몽땅쏙 is officially open. We offer various benefits for membership sign-ups.' },
        is_important: true
    },
    {
        id: '2',
...
export const FALLBACK_FAQS: FAQ[] = [
    {
        id: '1',
        question: { ko: '몽땅쏙의 운영 시간은 어떻게 되나요?', en: 'What are the operating hours of the 몽땅쏙?' },
        answer: { ko: '저희 몽땅쏙은 연중무휴로 오전 10시 30분부터 오후 8시까지 운영됩니다. 다만, 특별 행사가 있는 경우 운영 시간이 조정될 수 있으니 공지사항을 확인해 주시기 바랍니다.', en: 'The 몽땅쏙 is open year-round from 10:30 AM to 8:00 PM. However, please check the notices as hours may change for special events.' }
    },
    {
        id: '2',
    ...
    },
    {
        ...
        answer: { ko: '몽땅쏙 멤버십 회원이 되시면 모든 상품 구매 시 3% 포인트 적립, 생일 당일 10% 할인 쿠폰 발급, 그리고 시즌별 한정품 우선 구매권 등의 혜택을 누리실 수 있습니다.', en: '몽땅쏙 membership offers 3% point accumulation on all purchases, a 10% birthday discount coupon, and priority purchase rights for seasonal limited items.' }
    },
    {
        id: '4',
        question: { ko: '상품권 사용이 가능한가요?', en: 'Can I use gift certificates?' },
        answer: { ko: '네, 문화상품권, 백화점 상품권(신세계/롯데/현대) 및 몽땅쏙 전용 디지털 기프트카드를 모두 사용하실 수 있습니다.', en: 'Yes, Culture Gift Certificates, Department Store Gift Certificates (Shinsegae/Lotte/Hyundai), and 몽땅쏙-exclusive digital gift cards are all accepted.' }
    },
    {
        id: '5',
...
export const FALLBACK_PAGES = [
    { id: 'page-home', title: { ko: '홈', en: 'Home' }, description: { ko: '문화와 예술이 만나는 디지털 아카이브, 몽땅쏙의 메인 페이지입니다.', en: 'The main page of 몽땅쏙, a digital archive where culture and art meet.' }, url: '/' },
    { id: 'page-about', title: { ko: '소개', en: 'About' }, description: { ko: '몽땅쏙의 가치와 비전, 그리고 우리가 만들어가는 문화 생태계에 대해 소개합니다.', en: 'Introducing the values, vision, and cultural ecosystem of the 몽땅쏙.' }, url: '/about' },
    { id: 'page-notice', title: { ko: '공지사항', en: 'Notice' }, description: { ko: '몽땅쏙의 새로운 소식과 주요 안내사항을 확인하실 수 있습니다.', en: 'Check out the new news and major announcements from the 몽땅쏙.' }, url: '/notice' },
    ...
    { id: 'page-terms', title: { ko: '이용약관', en: 'Terms' }, description: { ko: '몽땅쏙 서비스 이용을 위한 법적 권리와 의무 사항을 규정합니다.', en: 'Regulating legal rights and obligations for using the 몽땅쏙 service.' }, url: '/terms' },
