...
export const FALLBACK_PRODUCTS: any[] = [
    ...
    // 2F Beauty & Care
    { id: 'p2-1', subcategory: 'skincare', category: 'floor2', title: { ko: '프리미엄 밸런싱 세럼', en: 'Premium Balancing Serum' }, description: { ko: '피부 속 깊은 곳까지 수분을 채워주는 고농축 영양 Serum입니다.', en: 'A highly concentrated nourishing serum that fills moisture deep into the skin.' }, image_url: '/via_station_logo_portal.png', price: '120,000₩' },
    { id: 'p2-2', subcategory: 'hair', category: 'floor2', title: { ko: '실크 리페어 헤어 에센스', en: 'Silk Repair Hair Essence' }, description: { ko: '손상된 모발에 즉각적인 윤기와 부드러움을 부여하는 프로페셔널 헤어 케어입니다.', en: 'Professional hair care that gives instant shine and softness to damaged hair.' }, image_url: '/via_station_logo_portal.png', price: '68,000₩' },
    { id: 'p2-3', subcategory: 'inner-beauty', category: 'floor2', title: { ko: '비타 부스트 콜라겐 앰플', en: 'Vita Boost Collagen Ampoule' }, description: { ko: '속부터 차오르는 생기를 위한 마시는 프리미엄 뷰티 솔루션입니다.', en: 'A drinking premium beauty solution for vitality from the inside out.' }, image_url: '/via_station_logo_portal.png', price: '85,000₩' },
