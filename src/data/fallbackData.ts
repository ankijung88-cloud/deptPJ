...
export const FALLBACK_NOTICES: Notice[] = [
    {
        id: '1',
        title: { ko: 'BUSINESS ARCHIVE 그랜드 오픈 및 멤버십 혜택 안내', en: 'Grand Opening & Membership Benefits' },
        category: '공지',
        date: '2024-03-01',
        content: { ko: 'BUSINESS ARCHIVE이 정식 오픈하였습니다. 멤버십 가입 시 다양한 혜택을 드립니다.', en: 'The BUSINESS ARCHIVE is officially open. We offer various benefits for membership sign-ups.' },
        is_important: true
    },
    {
        id: '2',
...
export const FALLBACK_FAQS: FAQ[] = [
    {
        id: '1',
        question: { ko: 'BUSINESS ARCHIVE의 운영 시간은 어떻게 되나요?', en: 'What are the operating hours of the BUSINESS ARCHIVE?' },
        answer: { ko: '저희 BUSINESS ARCHIVE은 연중무휴로 오전 10시 30분부터 오후 8시까지 운영됩니다. 다만, 특별 행사가 있는 경우 운영 시간이 조정될 수 있으니 공지사항을 확인해 주시기 바랍니다.', en: 'The BUSINESS ARCHIVE is open year-round from 10:30 AM to 8:00 PM. However, please check the notices as hours may change for special events.' }
    },
    {
        id: '2',
    ...
    },
    {
        ...
        answer: { ko: 'BUSINESS ARCHIVE 멤버십 회원이 되시면 모든 상품 구매 시 3% 포인트 적립, 생일 당일 10% 할인 쿠폰 발급, 그리고 시즌별 한정품 우선 구매권 등의 혜택을 누리실 수 있습니다.', en: 'BUSINESS ARCHIVE membership offers 3% point accumulation on all purchases, a 10% birthday discount coupon, and priority purchase rights for seasonal limited items.' }
    },
    {
        id: '4',
        question: { ko: '상품권 사용이 가능한가요?', en: 'Can I use gift certificates?' },
        answer: { ko: '네, 문화상품권, BUSINESS ARCHIVE 상품권(신세계/롯데/현대) 및 BUSINESS ARCHIVE 전용 디지털 기프트카드를 모두 사용하실 수 있습니다.', en: 'Yes, Culture Gift Certificates, Department Store Gift Certificates (Shinsegae/Lotte/Hyundai), and BUSINESS ARCHIVE-exclusive digital gift cards are all accepted.' }
    },
    {
        id: '5',
...
export const FALLBACK_PAGES = [
    { id: 'page-home', title: { ko: '홈', en: 'Home' }, description: { ko: '문화와 예술이 만나는 디지털 아카이브, BUSINESS ARCHIVE의 메인 페이지입니다.', en: 'The main page of BUSINESS ARCHIVE, a digital archive where culture and art meet.' }, url: '/' },
    { id: 'page-about', title: { ko: '소개', en: 'About' }, description: { ko: 'BUSINESS ARCHIVE의 가치와 비전, 그리고 우리가 만들어가는 문화 생태계에 대해 소개합니다.', en: 'Introducing the values, vision, and cultural ecosystem of the BUSINESS ARCHIVE.' }, url: '/about' },
    { id: 'page-notice', title: { ko: '공지사항', en: 'Notice' }, description: { ko: 'BUSINESS ARCHIVE의 새로운 소식과 주요 안내사항을 확인하실 수 있습니다.', en: 'Check out the new news and major announcements from the BUSINESS ARCHIVE.' }, url: '/notice' },
    ...
    { id: 'page-terms', title: { ko: '이용약관', en: 'Terms' }, description: { ko: 'BUSINESS ARCHIVE 서비스 이용을 위한 법적 권리와 의무 사항을 규정합니다.', en: 'Regulating legal rights and obligations for using the BUSINESS ARCHIVE service.' }, url: '/terms' },
