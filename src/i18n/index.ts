...
const resources = {
    ko: {
        translation: {
            ...
            "brand_vision": {
                "section_id": "VISION",
                "masthead": "VIA STATION EDITORIAL",
                ...
                "body_intro": "VIA STATION은 단순히 정보를 나열하는 웹사이트가 아닙니다. 우리는 공간을 렌더링하고 문화를 혁신하는 새로운 차원의 디지털 항구를 지향합니다. 기성 웹의 평면적 한계를 부수고, 가장 현대적인 기술 위에 찬란한 문화를 세우는 것. 그것이 우리의 시작입니다.",
                ...
                "body_essential": "정보의 홍수 속에서 우리는 길을 잃기도 합니다. VIA STATION은 수직적 공간 메타포를 통해 가장 직관적이고 예술적인 방식으로 당신의 취향을 찾아주는 '디지털 항구'이자 필수적인 라이프스타일 큐레이션입니다.",
                "pull_quote": "기술과 예술의 경계를 허무는 가장 혁신적이고 아름다운 큐레이션.",
                "body_conclusion": "결국 VIA STATION은 당신의 취향이 완성되는 마지막 기착지이자, 새로운 탐험이 시작되는 출발점입니다. 현대인에게 반드시 필요한 이 디지털 허브는 당신의 라이프스타일을 완성하는 마지막 조각이 될 것입니다."
            },
            "footer": {
