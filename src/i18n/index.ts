    ...
    ko: {
        translation: {
            ...
            "hero": {
                ...
                "story": "로그인",
                "philosophy": "모집 공고",
                "welcome": "Welcome to MONGTANG",
                "site_description": "다양한 아카이브를 자유롭게 넘나들며 나만의 라이프스타일을 완성하는 메타 게이트웨이. 모든 여정이 특별한 발견과 연결로 이어지는 프리미엄 통합 플랫폼, MONGTANG입니다.",
                "start": "시작하기",
                "vision": "비전",
                "features": "기능",
                "partners": "입점사",
            ...
            "brand_vision": {
                "masthead": "MONGTANG VISIONARY",
                "headline": "디지털 비즈니스의 새로운 지평: 시공간을 초월한 혁신",
                "subheadline": "우리는 단순한 가상 공간을 넘어, 가상융합(XR) 및 첨단기술 창업가들이 직접 모이고 성장하는 압도적인 비즈니스 허브를 구축합니다.",
                "metadata": "SPECIAL REPORT | MONGTANG OPERATION TEAM",
                "body_intro": "MONGTANG은 단순한 2D 홍보관이 아닙니다. 물리적 제약을 부수고 기업의 아이덴티티가 살아 숨쉬는 혁신적인 가상 오피스 모델을 제시합니다. 전 세계 어디서나 직관적으로 접속하여 협업하고 차원 높은 비즈니스를 전개하는 것. 그것이 우리의 시작입니다.",
                "body_philosophy": "전통 한지의 질감을 현대적으로 재해석한 MONGTANG의 솔리드 디자인은 흔들리지 않는 비즈니스의 본질과 신뢰를 상징합니다. 입주 기업들은 단순한 오피스를 임대하는 것을 넘어, 브랜드의 철학이 단단하고 입체적으로 구현된 프리미엄 비즈니스 환경을 경험하게 됩니다.",
            ...
            "footer": {
                ...
                "copyright": "© 2026 MONGTANG. All rights reserved.",
                "privacy": "개인정보처리방침",
                "terms": "이용약관",
                "shop": "SHOP",
                "support": "지원",
    ...
    en: {
        translation: {
            ...
            "common": {
                ...
                "external_link_go": "Go to External Link",
