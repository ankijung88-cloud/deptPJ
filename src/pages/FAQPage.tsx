...
const FAQ_DATA = [
    {
        id: '1',
        question: 'FLOOR C의 운영 시간은 어떻게 되나요?',
        answer: '저희 FLOOR C는 연중무휴로 오전 10시 30분부터 오후 8시까지 운영됩니다. 다만, 특별 행사가 있는 경우 운영 시간이 조정될 수 있으니 공지사항을 확인해 주시기 바랍니다.'
    },
    {
        id: '2',
        question: '주차는 가능한가요?',
    ...
    },
    {
        ...
        answer: 'FLOOR C 멤버십 회원이 되시면 모든 상품 구매 시 3% 포인트 적립, 생일 당일 10% 할인 쿠폰 발급, 그리고 시즌별 한정품 우선 구매권 등의 혜택을 누리실 수 있습니다.'
    },
    {
        id: '4',
        question: '상품권 사용이 가능한가요?',
        answer: '네, 문화상품권, 백화점 상품권(신세계/롯데/현대) 및 FLOOR C 전용 디지털 기프트카드를 모두 사용하실 수 있습니다.'
    },
    {
        id: '5',
