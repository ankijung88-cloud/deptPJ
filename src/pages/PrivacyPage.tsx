    ...
    return (
        <div className="min-h-screen bg-transparent text-dancheong-ink pb-20">
            <div className="lossless-layout pt-32">
                ...
                {/* Content Section */}
                <div className="max-w-4xl mx-auto bg-white/60 border border-dancheong-ink/5 rounded-3xl p-8 md:p-16 shadow-[0_20px_50px_rgba(0,0,0,0.03)] overflow-hidden relative">
