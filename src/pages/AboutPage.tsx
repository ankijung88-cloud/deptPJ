                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 mt-24">
                    ...
                    >
                        ...
                        <h1 className="text-6xl md:text-[9rem] font-serif font-black mb-8 tracking-tighter leading-[0.85] drop-shadow-2xl">
                             <span className="text-dancheong-red"><AutoTranslatedText text="HXVA ARCADE" /></span><br /><AutoTranslatedText text="OF K-CULTURE" />
                        </h1>
                ...
                <FadeInContent>
                    <div className="bg-white/5 backdrop-blur-md rounded-[3rem] p-12 md:p-20 border border-white/10 text-center mt-6 shadow-2xl">
                        <h3 className="text-3xl md:text-5xl font-light italic text-white/90 mb-20 leading-tight">
                            <AutoTranslatedText text='"기술과 예술의 경계를 허무는' /><br /><AutoTranslatedText text=' 디지털 문법의 새로운 질서, "' /><span className="font-serif font-bold text-dancheong-gold"><AutoTranslatedText text="HXVA ARCADE" /></span><AutoTranslatedText text='"' />
                        </h3>
                    ...
                    <div className="py-24 w-full relative">
                        ...
                        <div className="relative z-10 max-w-4xl mx-auto mt-8">
                            ...
                            <p className="text-2xl text-white/60 font-light break-keep leading-relaxed mb-16">
                                <AutoTranslatedText text="HXVA ARCADE 프로젝트는 단순한 코딩을 넘어 하나의 하이엔드 브랜드를 런칭하는 마스터피스입니다. 웹 공간의 한계를 부수고, 가장 현대적인 기술 위에 찬란한 문화를 세웁니다." />
                            </p>
