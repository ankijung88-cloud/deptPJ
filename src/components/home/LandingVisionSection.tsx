...
export const LandingVisionSection: React.FC = () => {
    return (
        <section className="relative w-full py-32 px-6 bg-[#05070D] flex flex-col items-center justify-center overflow-hidden">
            {/* Background elements */}
            <div className="absolute inset-0 pointer-events-none z-0">
                <div className="absolute top-[20%] left-[-10%] w-[50%] h-[50%] bg-dancheong-red/5 blur-[150px] rounded-full" />
                <div className="absolute bottom-[20%] right-[-10%] w-[50%] h-[50%] bg-dancheong-blue/5 blur-[150px] rounded-full" />
            </div>
