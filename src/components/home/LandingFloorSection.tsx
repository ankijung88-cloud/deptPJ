    ...
    return (
        <section id="floors" className="relative w-full sm:min-h-screen bg-transparent border-t border-dancheong-ink/5 overflow-hidden flex flex-col justify-center pt-8 pb-16 sm:py-24">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10">
                ...
                <header className="max-w-4xl mx-auto text-center mb-6 sm:mb-16 lg:mb-24">
                    <div className="flex flex-col items-center gap-2 mb-4 sm:mb-8">
                        <div className="flex items-center gap-3 sm:gap-4 opacity-80">
                            <div className="h-[1.5px] w-6 sm:w-8 lg:w-12 bg-dancheong-ink" />
                            <span className="text-[8px] sm:text-[9px] lg:text-[10px] font-black tracking-[0.3em] sm:tracking-[0.5em] text-dancheong-mugwort uppercase">
                    ...
                    <div className="w-full mb-6 sm:mb-10">
                        <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif font-bold tracking-tighter leading-[1.2] text-dancheong-ink flex flex-col items-center justify-center px-2">
                            <motion.span
                    ...
                    {displayFloors.map((floor, index) => {
                        ...
                        return (
                            ...
                            >
                                {/* Square Floor Card */}
                                <div
                                    className={`w-full aspect-square p-2 sm:p-4 lg:p-6 rounded-[1rem] sm:rounded-[2rem] lg:rounded-[2.5rem] transition-all duration-500 relative overflow-hidden flex flex-col items-center text-center justify-center ${isActive ? 'shadow-[0_20px_50px_rgba(26,26,26,0.1)] sm:-translate-y-4' : 'shadow-[0_4px_20px_rgba(26,26,26,0.03)]'}`}
                                    style={{
                                ...
                                >
                                    ...
                                    <div className="relative z-10 flex flex-col items-center justify-between h-full w-full py-0.5 sm:py-1 lg:py-2">
                                        {/* Top: Floor Number - Fixed Position */}
                                        <div className="flex flex-col items-center gap-0.5 lg:gap-1">
                                            <div
                                                className={`text-base sm:text-2xl lg:text-4xl font-serif italic transition-all duration-500 ${isActive ? 'scale-110 opacity-100 font-black' : 'opacity-40 text-dancheong-ink'}`}
                                                style={{ color: isActive ? floor.color : undefined }}
                                            >
                                                {floor.floor}
                                            </div>
                                            <div
                                                className="w-3 sm:w-4 h-[1px] sm:h-[1.5px] transition-all duration-500"
                                                style={{ backgroundColor: isActive ? floor.color : 'rgba(23,23,23,0.1)' }}
                                            />
                                        </div>

                                        {/* Middle: Title */}
                                        <div className="flex-grow flex items-center justify-center w-full py-0.5 sm:py-2">
                                            <h3 className={`text-[7px] sm:text-[11px] lg:text-sm font-serif font-black tracking-tight leading-tight transition-all duration-500 max-w-[95%] ${isActive ? 'text-dancheong-ink' : 'text-dancheong-ink/60'}`}>
                                        ...
                                        <div
                                            className={`w-5 h-5 sm:w-8 sm:h-8 lg:w-10 lg:h-10 flex items-center justify-center transition-all duration-700 relative ${isActive ? 'scale-110' : ''}`}
                                            style={{
                                        ...
                                        >
                                            ...
                                            {/* Inner Stamped Ring */}
                                            <div className="absolute inset-[3px] sm:inset-[4px] lg:inset-[5px] rounded-full border border-black/10 shadow-inner" />
                ...
                <div className="mt-8 sm:mt-16 lg:mt-24 text-center">
                    <p className="max-w-2xl mx-auto text-base md:text-lg text-dancheong-ink/60 font-bold leading-tight px-4 whitespace-pre-line">
                        <AutoTranslatedText text={"위의 층별 카드를 클릭하여 지금 바로 가상 공간으로의 몰입형 탐험을 시작해 보세요."} />
                    </p>
                </div>
            </div>
