    ...
    return (
        <section id="floors" className="relative w-full min-h-screen bg-transparent border-t border-dancheong-ink/5 overflow-hidden flex flex-col justify-center py-20">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10">
                ...
                <header className="max-w-4xl mx-auto text-center mb-10 sm:mb-16 lg:mb-24">
                    ...
                    <div className="w-full mb-6 sm:mb-10">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif font-bold tracking-tighter leading-[1.2] text-dancheong-ink flex flex-col items-center justify-center px-2">
                            <motion.span
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4 lg:gap-6 w-full">
                    {sortedFloors.reverse().map((floor, index) => {
                        ...
                        return (
                            ...
                            >
                                    {/* Square Floor Card */}
                                    <div
                                        className={`w-full aspect-square p-3 sm:p-4 lg:p-6 rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] transition-all duration-500 relative overflow-hidden flex flex-col items-center text-center justify-center ${isActive ? 'shadow-[0_20px_50px_rgba(26,26,26,0.1)] sm:-translate-y-4' : 'shadow-[0_4px_20px_rgba(26,26,26,0.03)]'}`}
                                        style={{
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10 flex flex-col items-center justify-between h-full w-full py-0.5 sm:py-1 lg:py-2">
                                            ...
                                            <div className="flex flex-col items-center gap-0.5 lg:gap-1">
                                                <div
                                                    className={`text-xl sm:text-2xl lg:text-4xl font-serif italic transition-all duration-500 ${isActive ? 'scale-110 opacity-100 font-black' : 'opacity-40 text-dancheong-ink'}`}
                                            ...
                                            {/* Middle: Title */}
                                            <div className="flex-grow flex items-center justify-center w-full py-1 sm:py-2">
                                                <h3 className={`text-[9px] sm:text-[11px] lg:text-sm font-serif font-black tracking-tight leading-tight transition-all duration-500 max-w-[95%] ${isActive ? 'text-dancheong-ink' : 'text-dancheong-ink/60'}`}>
                                            ...
                                            {/* Compact Detailed Wax Seal Button */}
                                             <div
                                                 className={`w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 flex items-center justify-center transition-all duration-700 relative ${isActive ? 'scale-110' : ''}`}
                                                 style={{
