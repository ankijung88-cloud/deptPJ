...
export const HeroSection: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <section
        id="hero"
        className="relative h-[30vh] sm:h-screen w-full bg-dancheong-ivory animate-pulse"
      />
    );
  }
  ...
  if (images.length === 0) {
    return (
      <section
        id="hero"
        className="relative h-[30vh] sm:h-screen w-full flex items-center justify-center bg-dancheong-ivory"
      >
  ...
  return (
    <section
      id="hero"
      className="relative h-[40vh] sm:h-screen w-full overflow-hidden bg-white group/hero"
    >
              ...
              <div className="max-w-4xl">
                ...
                >
                  ...
                  <p className="text-sm sm:text-xl md:text-2xl text-white/70 max-w-xl font-medium leading-tight italic">
                    <AutoTranslatedText text="당신이 원하는 당신의 것을 찾는" />{' '}
                    <br className="hidden sm:block" />
                    <AutoTranslatedText text="플로우 큐레이션" />
                  </p>
