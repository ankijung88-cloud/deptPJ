...
export const LandingFooterCTA: React.FC<LandingFooterCTAProps> = ({ onExplore }) => {
    return (
        <section className="relative w-full py-32 px-6 bg-[#05070D] flex flex-col items-center justify-center border-t border-white/5">
            ...
            <div className="relative z-10 text-center max-w-4xl mx-auto">
                <motion.h2
                    ...
                    viewport={{ once: true }}
                    className="text-4xl md:text-5xl lg:text-7xl font-black text-white mb-8 tracking-tighter mix-blend-screen"
                >
                ...
                >
                    <button
                        onClick={onExplore}
                        className="px-12 py-5 bg-[#FF3B30] text-white text-lg font-bold rounded-full hover:bg-[#e6352b] transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_rgba(255,59,48,0.5)] tracking-[0.2em] uppercase"
                    >
