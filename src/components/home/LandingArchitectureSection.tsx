...
const archFeatures = [
    {
        id: 'engine',
        icon: <Layers className="w-6 h-6 text-[#FFD700]" />,
    ...
    {
        id: 'security',
        icon: <Shield className="w-6 h-6 text-dancheong-green" />,
...
export const LandingArchitectureSection: React.FC = () => {
    return (
        <section className="relative w-full py-32 px-6 bg-[#05070D] flex flex-col items-center border-t border-white/5">
            <div className="max-w-6xl mx-auto w-full relative z-10">
                <div className="flex flex-col lg:flex-row gap-16 items-start">
                    ...
                    >
                        <h3 className="text-dancheong-blue text-sm tracking-[0.3em] uppercase mb-4">
                            <AutoTranslatedText text="System Architecture" />
                        </h3>
                        <h2 className="text-3xl md:text-5xl text-white font-bold mb-6 tracking-tight leading-tight">
                            <AutoTranslatedText text="강력하고 유연한" /><br />
                            <AutoTranslatedText text="플랫폼 인프라" />
                        </h2>
                        <p className="text-white/50 leading-relaxed font-light break-keep">
                    ...
                    <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
                        {archFeatures.map((feature, idx) => (
                            <motion.div
                                ...
                                className="bg-[#0A100D] border border-white/10 rounded-[2rem] p-8 hover:bg-white/5 hover:border-white/20 transition-all duration-300 group shadow-2xl relative overflow-hidden"
                            >
                                ...
                                <div className="mb-6 p-4 rounded-full inline-flex bg-black/50 border border-white/5 backdrop-blur-md">
                                    {feature.icon}
                                </div>
                                <h4 className="text-xl font-bold text-white mb-4 tracking-wide">
                                    <AutoTranslatedText text={feature.title} />
                                </h4>
                                <p className="text-white/50 text-sm leading-relaxed break-keep font-light">
